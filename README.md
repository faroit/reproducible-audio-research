...
If your presentation relies on MathJax and your internet connection is unreliable you might want download the MathJax library. One way to do this would be to install mathjax via node:

```sh
  npm install mathjax
```

and then set the mathjax lib path to the node module path:


```js
  math: { mathjax: 'node_modules/mathjax/MathJax.js'}
```
